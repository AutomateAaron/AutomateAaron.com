...
>
  ...
  >
    ...
    />
    <BreathingBlob
      class="absolute -left-32 -top-32 -z-30 h-64 w-64 -rotate-90 animate-move-top text-base-300"
    />
  </div>
  <Figure class="absolute -left-32 bottom-4 -z-10 h-48 w-48 animate-pulse" />
</section>
