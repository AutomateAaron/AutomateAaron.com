...
>
	<div class="relative rounded-xl bg-base-100 px-12 py-12 shadow-xl md:px-24 md:py-12">
		...
		>
		<FigureSmall class="absolute -left-12 -top-12 -z-10 h-36 w-36 animate-move-left" />
		<BreathingBlob class="absolute -bottom-32 -right-32 -z-30 h-64 w-64 rotate-180 text-base-300" />
	</div>
	<Figure class="absolute -right-32 bottom-4 -z-10 h-48 w-48 animate-move-top" />
</section>
